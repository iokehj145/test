...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function fetchTopicsCount() {
        fetch('https://server-cop3xg6zj-iokehjs-projects.vercel.app/api/topics/count')
    ...
    function fetchPostsCount() {
        fetch('https://server-cop3xg6zj-iokehjs-projects.vercel.app/api/messages/count')
            .then(response => response.json())
            .then(data => {
...
const CreatThread = async () => {
    ...
    fetch('https://server-cop3xg6zj-iokehjs-projects.vercel.app/topic', {
        method: 'POST',
        headers: {
